...
public class VideoThumbCreator {
     ...
     * @return
     */
    public static byte[] makeSnapshot(String inputFilename, long timestamp, Integer maxWidth, Integer maxHeight) throws Exception {
...
//        makeSnapshot(inputFilename, timestamps, outputdir, outputFilePrefix, 100, 100);
//    }
//
}